...
<html>
    ...
    <body>
            ...
            <?php
                ...
                $querySelecao= "SELECT *FROM ADOTAPETDB.PET";
                ...
                while( $imagem= mysqli_fetch_object($resultado)){ ?>
                     ...
                     <div class="col-sm-4 col-lg-4 col-md-4">
                        <div class="thumbnail">
                            <img src="data:image/gif;base64,<?php echo base64_encode($imagem->Imagem)?>" alt=""> 
                            <div class="caption">
                                <h4 class="pull-right">Sexo: <?php echo $imagem->Sexo; ?></h4>
                                <h4><a href="#"><?php echo $imagem->Nome; ?></a>
                                </h4>
